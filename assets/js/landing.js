(() => {
    ...
    const audienceCopy = {
        buyer: {
            pageTitle: "Use Borage — Tell us what you need. Get it done.",
            status: "Buyer view",
        ...
        professional: {
            pageTitle: "Use Borage — Do the work. Not the chasing.",
            ...
            signalRequestCopy: "Packaging artwork · £350–£450 · 05 Sep · 2 revisions",
    ...
    const projects = {
        ...
        research: {
            request: "We need to understand how five UK competitors package and price their compliance products. We need useful evidence, not a huge report, for a strategy session next month.",
